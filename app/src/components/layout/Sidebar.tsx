...
export function Sidebar({ mobileOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={clsx(
          'w-[246px] shrink-0 bg-sidebar text-sidebar-idle p-4 flex flex-col border-r border-white/10',
      ...
      >
        <div className="flex items-center justify-between px-2 pb-[22px]">
          ...
          <button
            ...
            className="md:hidden w-8 h-8 flex items-center justify-center text-sidebar-idle hover:text-white"
          >
            ✕
          </button>
        </div>
